...
"""
    ...
    if "NOT RESPONDING" not in out:
        ...
        print(f"   Backend URL: https://192.168.1.8:8000")
        print(f"   Mobile cam:  https://192.168.1.8:8000/mobile")
        print(f"   Model: {model_path}")
        print("=" * 60)
    else:
        print("\n⚠ Backend may still be starting up. Check with:")
        print(f"   ssh mandar@192.168.1.8 'tail -50 /tmp/overwatch.log'")
